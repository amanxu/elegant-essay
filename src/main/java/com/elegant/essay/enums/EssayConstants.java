 ...
 * @description:
 * @author: xiaoxu.nie
 * @date: 2018-12-02 20:33
 */
public class EssayConstants {

    public static String BLANK = " ";

    public static String BLANK_TRIM = "";
    ...
    public static String ESSAY_ES_TOPIC = "ESSAY_ES_TOPIC";

    public static String STANDARD_DATE_TIME = "yyyy-MM-dd HH:mm:ss";

    public static String STANDARD_DATE = "yyyy-MM-dd";

    public static final String IGNORE_URL = "ESSAY_IGNORE_URL";

    public static StringBuilder essayBuf = new StringBuilder("１９７５年二、三月间，一个平平常常的日子，细蒙蒙的雨丝夹着一星半点的雪花，正纷纷淋淋地向大地飘洒着。时令已快到惊蛰，雪当然再不会存留，往往还没等落地，就已经消失得无踪无影了。黄土高原严寒而漫长的冬天看来就要过去，但那真正温暖的春天还远远地没有到来。" +
